...
XPATH_LINK_TEASER = '//div[@class="b-main-page-grid-4 b-main-page-news-2"]/ul/li/a[@class="b-teasers-2__teaser-i"]/@href' # rubocop:disable Layout/LineLength
...
XPATH_LINK_AUTO = '//div[@class="b-main-page-grid-4__col b-main-page-grid-4__col-1x1 news-2__secondary-news-col"]/section/article/figure/a/@href' # rubocop:disable Layout/LineLength
XPATH_LINK_TECH = '//div[@class="b-main-page-grid-4__col b-main-page-grid-4__col-1x2 news-2__news-list-col"]/ul/li/figure/a/@href' # rubocop:disable Layout/LineLength
